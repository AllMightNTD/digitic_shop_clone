...
const OurStore = () => {
    ...
    return (
        <>
            ...
            <div className="store-wrapper home-wrapper-two py-5">
                <div className="px-3">
                                ...
                                <div className="d-flex align-items-center gap-10 grid-group">
                                    ...
                                    <div className="d-flex gap-10 align-items-center ">
                                        <div className="grid-img" onClick={() => setGrid(4)}>
                                            <img src="images/gr.svg" className="img-fluid d-block" alt="grid"></img>
                                        </div>
                                        <div className="grid-img" onClick={() => setGrid(2)}>
                                            <img src="images/gr2.svg" className="img-fluid d-block" alt="grid"></img>
                                        </div>
                                        <div className="grid-img" onClick={() => setGrid(3)}>
                                            <img src="images/gr3.svg" className="img-fluid d-block" alt="grid"></img>
                                        </div>
                                        <div className="grid-img" onClick={() => setGrid(6)}>
                                            <img src="images/gr4.svg" className="img-fluid d-block" alt="grid"></img>
                                        </div>
                                    </div>
                                </div>
                            </div>
