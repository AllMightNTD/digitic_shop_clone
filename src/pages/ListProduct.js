            ...
            <div className="d-flex home-wrapper-two px-3 py-3 gap-15 filter_wrapper align-items-center justify-content-between">
                ...
                <div className="d-flex align-items-center gap-15 filter_by-price">
                    {/* <div className="form-floating">
                        <input
                            onChange={(e) => setFilterPrice({ ...filterPrice, from: e.target.value })}
                            type="text"
                    ...
                    <div className="form-floating">
                        <input
                            onChange={(e) => setFilterPrice({ ...filterPrice, to: e.target.value })}
                            type="text"
                    ...
                    <select onChange={(e) => setSortType(e.target.value)} className="px-2 py-2 border-0">
